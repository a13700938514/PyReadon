...
# Form implementation generated from reading ui file 'D:\QQPCmgr\Desktop\eric\PyReadon V0.42\PyReader.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/newPrefix/info.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.layout.setText(_translate("MainWindow", "网格布局"))
        self.layout.setToolTip(_translate("MainWindow", "网格布局"))
        self.infobar.setText(_translate("MainWindow", "软件信息"))
